...
#define SourceDir "E:\dev\bookmarks-standalone"
...
OutputBaseFilename=BookmarksSetup
SetupIconFile={#SourceDir}\vs2015\Bookmarks\icon.ico
...
UninstallDisplayIcon={#SourceDir}\vs2015\Bookmarks\icon.ico
...
; mBookmarks
Source: {#SourceDir}\package\Lib\site-packages\bookmarks\context\mBookmarks.py; DestDir: {userdocs}\maya\plug-ins; Components: maya; Flags: ignoreversion recursesubdirs createallsubdirs; Permissions: users-modify
