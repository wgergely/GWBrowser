...
; Example templates
Source:  {#SourcePath}..\..\example-templates\example_asset.zip; DestDir: {localappdata}\{#MyAppName}\asset_templates; Flags: ignoreversion recursesubdirs createallsubdirs; Permissions: users-modify
Source:  {#SourcePath}..\..\example-templates\example_job.zip; DestDir: {localappdata}\{#MyAppName}\job_templates; Flags: ignoreversion recursesubdirs createallsubdirs; Permissions: users-modify
