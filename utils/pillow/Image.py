...
from browser.utils.pillow import VERSION, PILLOW_VERSION, __version__, _plugins
from browser.utils.pillow._util import py3
...
from browser.utils.pillow import ImageMode
from browser.utils.pillow._binary import i8
from browser.utils.pillow._util import isPath, isStringType, deferred_error
...
try:
    ...
    from browser.utils.pillow import _imaging as core
...
def preinit():
    ...
    try:
        from browser.utils.pillow import BmpImagePlugin
        assert BmpImagePlugin
    except ImportError:
        pass
    try:
        from browser.utils.pillow import GifImagePlugin
        assert GifImagePlugin
    except ImportError:
        pass
    try:
        from browser.utils.pillow import JpegImagePlugin
        assert JpegImagePlugin
    except ImportError:
        pass
    try:
        from browser.utils.pillow import PpmImagePlugin
        assert PpmImagePlugin
    except ImportError:
        pass
    try:
        from browser.utils.pillow import PngImagePlugin
...
class Image(object):
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def _new(self, im):
        ...
        if im.mode in ('P', 'PA'):
            if self.palette:
                ...
                from browser.utils.pillow import ImagePalette
    ...
    def load(self):
        ...
        if self.im:
            if cffi and USE_CFFI_ACCESS:
                ...
                from browser.utils.pillow import PyAccess
    ...
    def filter(self, filter):
        ...
        from browser.utils.pillow import ImageFilter
    ...
    def paste(self, im, box=None, mask=None):
        ...
        if isStringType(im):
            from browser.utils.pillow import ImageColor
    ...
    def toqimage(self):
        ...
        from browser.utils.pillow import ImageQt
...
def _showxv(image, title=None, **options):
    from browser.utils.pillow import ImageShow
