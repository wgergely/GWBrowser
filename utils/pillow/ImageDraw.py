...
from browser.utils.pillow import Image, ImageColor
...
class ImageDraw(object):
    ...
    def getfont(self):
        ...
        if not self.font:
            ...
            from browser.utils.pillow import ImageFont
...
def getdraw(im=None, hints=None):
    ...
    if not hints or "nicest" in hints:
        try:
            from browser.utils.pillow import _imagingagg as handler
        except ImportError:
            pass
    if handler is None:
        from browser.utils.pillow import ImageDraw2 as handler
    if im:
        im = handler.Draw(im)
    return im, handler
