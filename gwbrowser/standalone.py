...
if __name__ == '__main__':
    ...
    packagepath = sys.argv[0]
    pkg_path = os.path.normpath(os.path.join(packagepath, os.pardir))

    # Making the
    if 'PYTHONPATH' not in os.environ:
        env_paths = ''
    else:
        env_paths = os.environ['PYTHONPATH']

    env_paths = env_paths.split(';')
    # env_paths.insert(0, )
    env_paths = ';'.join(env_paths)

    os.environ['PYTHONPATH'] = env_paths
